# -*- coding: utf-8 -*-
{
    ...
    'data': [
        ...
        'views/insurance/medical_insurance_view.xml',
        'views/insurance/medical_insurance_menu.xml',
    ],
