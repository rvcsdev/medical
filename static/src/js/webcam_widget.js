...
*/
odoo.define('medical.webcam_widget', function(require) {
    "use strict";
    ...
    core.form_widget_registry.get("image").include({
        ...
        render_value: function () {
            ...
            Webcam.set({
                ...
                force_flash: false,
                fps: 45,
                swfURL: '/medical/static/src/js/webcam.swf',
            });

            self.$el.find('.oe_form_binary_file_clear').removeClass('col-md-offset-5');

            new Model('ir.config_parameter').call('get_param', ['medical.flash_fallback_mode', false]).
            ...
            self.$el.find('.oe_form_binary_file_web_cam').off().on('click', function(){
                ...
                WebCamDialog.find("#webcam_result").html('<img src="/medical/static/src/img/webcam_placeholder.png"/>');
            });
        },
    });
